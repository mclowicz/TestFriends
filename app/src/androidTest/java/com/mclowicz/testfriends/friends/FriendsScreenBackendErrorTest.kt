...
import com.mclowicz.testfriends.UnavailableFriendsCatalog
...
class FriendsScreenBackendErrorTest {
    ...
    class TestModule {
        ...
        @Provides
        @Singleton
        fun provideUserCatalog(): UserCatalog = UnavailableFriendsCatalog()
